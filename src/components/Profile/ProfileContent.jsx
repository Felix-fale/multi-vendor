          ...
          <div className="flex justify-center w-full">
            <div className="relative">
              <img
                ...
                src={user && user.avatar ? `${backend_url}${user.avatar}` : ""}
...
// Part 2    02:2700s Payment method
  ...
  return (
    <div className="w-full px-5">
      ...
      <div className="w-full bg-white h-min 800px:h-[70px] rounded-[4px] flex items-center px-3 shadow justify-between pr-10 mb-5">
        ...
        <div className="pl-8 flex items-center">
          <h6 className="text-[12px] 800px:text-[unset]">(+228) 90-07-65-82</h6>
        </div>
        <div className="min-w-[10%] flex items-center justify-between pl-8">
